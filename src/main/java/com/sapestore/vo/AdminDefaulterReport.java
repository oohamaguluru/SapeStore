 ...
 */
public class AdminDefaulterReport implements Serializable,Comparable<AdminDefaulterReport>{
	...
	@Override
	public int compareTo(AdminDefaulterReport admin) {
		// TODO Auto-generated method stub
	return this.getCustomerName().compareTo(admin.getCustomerName());
	}
}