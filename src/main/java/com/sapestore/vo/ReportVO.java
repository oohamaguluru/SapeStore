...
public class ReportVO implements Serializable{
	...
	/**
	 * @param integer the bookPrice to set
	 */
	public void setBookPrice(double integer) {
		this.bookPrice = integer;
	}
	@Override
	public String toString() {
		return "ReportVO [publisherName=" + publisherName + ", bookTitle=" + bookTitle + ", quantity=" + quantity
				+ ", bookAuthor=" + bookAuthor + ", categoryName=" + categoryName + ", bookPrice=" + bookPrice
				+ ", orderType=" + orderType + ", isbn=" + isbn + ", rentPrice=" + rentPrice + "]";
	}
	/**
	 * @return the isbn
	 */
