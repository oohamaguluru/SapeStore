...
public class Address implements Serializable{
	...
	public String toString() {
		return "Address [userId=" + userId + ", addressId=" + addressId + ", stateId=" + stateId + ", countryId="
				+ countryId + ", addressLine1=" + addressLine1 + ", addressLine2=" + addressLine2 + ", cityId=" + cityId
				+ ", postalCode=" + postalCode + ", createdDate=" + createdDate + ", updatedDate=" + updatedDate
				+ ", isActive=" + isActive + ", mobileNumber=" + mobileNumber + ", name=" + name + "]";
	}
