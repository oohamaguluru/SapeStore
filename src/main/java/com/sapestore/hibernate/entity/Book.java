...
@NamedQueries(value = {
		...
		@NamedQuery(name = "Book.findAllInventory", query = "from Book b where b.isActive ='Y' order by b.categoryId,lower(b.bookTitle) "),
		@NamedQuery(name="Book.findZeroReviews",query="select c.isbn from Book c where c.isbn not in(select b.isbn from BookRatingComments b)" )
		//@NamedQuery(name = "Book.findAllInventory", query = "from Book b where b.isActive ='Y' order by b.categoryId ")
		})
public class Book implements Serializable{
	...
	/**
	 * @param i the bookPrice to set
	 */
	/*public void setBookPrice(BigDecimal i) {
		this.bookPrice = i;
	}*/

	public void setBookPrice(double bigDecimal) {
	...
	public String toString() {
		return "Book [isbn=" + isbn + ", publisherName=" + publisherName + ", categoryId=" + categoryId
				+ ", bookCategory=" + bookCategory + ", categoryName=" + categoryName + ", bookTitle=" + bookTitle
				+ ", quantity=" + quantity + ", bookAuthor=" + bookAuthor + ", bookThumbImage=" + bookThumbImage
				+ ", bookFullImage=" + bookFullImage + ", bookShortDescription=" + bookShortDescription
				+ ", bookDetailDescription=" + bookDetailDescription + ", createdDate=" + createdDate + ", updatedDate="
				+ updatedDate + ", isActive=" + isActive + ", rentAvailability=" + rentAvailability + ", rentPrice="
				+ rentPrice + ", lateFee=" + lateFee + ", isFromPartnerStore=" + isFromPartnerStore + ", averageRating="
				+ averageRating + ", bookPrice=" + bookPrice + "]";
	}
