...
@NamedQueries(value = {
		...
		@NamedQuery(name = "City.findByCityName", query = "from City c where c.cityName = :cityName"),
		@NamedQuery(name = "City.findByStateId", query = "from City c where c.stateId = :stateId")
 		})
