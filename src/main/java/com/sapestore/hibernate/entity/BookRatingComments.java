...
@NamedQueries(value = {
		...
		@NamedQuery(name="BookRatingComments.findIsbn",query="select c.isbn from BookRatingComments c, Book b where c.isbn=b.isbn group by c.isbn Order by count(c.isbn) desc"),
		@NamedQuery(name="BookRatingComments.allIsbns",query="select d.isbn from BookRatingComments d")
...
public class BookRatingComments implements Serializable{
	...
	public String toString() {
		return "BookRatingComments [commentId=" + commentId + ", isbn=" + isbn + ", userId=" + userId
