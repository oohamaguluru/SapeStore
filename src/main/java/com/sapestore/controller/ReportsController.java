...
public class ReportsController {
    ...
    */
    ...
    public String adminReport(Model modelMap) throws SapeStoreException {
                    LOGGER.debug("adminReport method: START");
                    System.out.println("In controller - /adminReport");
                    this.setAdminReportList(reportService.getAdminReport());
                    modelMap.addAttribute("adminReportsList", this.getAdminReportList());
