...
$("#transactionForm").submit();
       ...
       <div id="wrapper">
              ...
              <div id="mainContent">
                     ...
                     <div id="showDetails">
	                     <p style="font-family: SapientSansRegular; font-size: 15px;"><spring:message code="label.orderstatus.success"/><span style="font-family: SapientSansMedium; font-size: 15px; text-decoration: underline ;color: #de2728; ">${orderId}</span><spring:message code="label.orderstatus.success1"/></p>
