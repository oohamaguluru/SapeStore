                     ...
                     <div id="header">
                           ...
                           <ul class="topLinks">
                                  <li>
                                         ...
                                         <label for="checkMe" style="font-size: 13px;"><spring:message code="label.header.partnerstore"/></label> 
                                   ...
                                   <table id="tablepaging" class="yui" cellspacing="30" cellpadding="10">
                                         <thead>
                                                <tr>
                                                       ...
                                                       <th align="left" colspan="2"><spring:message code="label.transactionhistory.nameandauth"/></th>
