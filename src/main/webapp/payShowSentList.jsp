...
<b>Sent Transaction history</b>
<c:choose>
<c:when test="${empty sentlist}">
<br><br>Sorry sent history is empty!
</c:when>
<c:otherwise>
<table id="tablepagingpay" class="yui" cellspacing="50" cellpadding="10">
  <tr>
...
<script type="text/javascript">
              var pager = new Pager('tablepagingpay', 4);
              pager.init();
