	...
	<div id="wrapper">
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<li class="active"><a href="#login" title="review"
								class="inline" id="addToCart">WISHLIST</a></li>
						</c:otherwise>
					</c:choose>
		...
		<div id="mainContent">
			...
			<form action="/SapeStore/trackOrder" id="submitForm">
				<p style="font-family: SapientSansMedium; font-size: 15px;">
					<spring:message code="label.orderstatus.heading1"/><span
						style="font-family: SapientSansMedium; font-size: 15px; color: #de2728;">*</span>
				</p>
				<input type="text" id="numberField" name="orderId">&nbsp <input
					type="button" onclick="validate()"
					value="<spring:message code="label.orderstatus.button1"/>"
					style="font-family: Sapient Centro Slab; font-size: 15px; color: #ffffff; background-color: #21addd">
			</form>
			<div id="nerrorDiv" style="color: red; display: none">Please
				enter a value</div>
			<div id="serrorDiv" style="color: red; display: none">Please
				enter an integer</div>

			<form action="/SapeStore/trackOrderType">
				<p style="font-family: SapientSansMedium; font-size: 15px;">
					<spring:message code="label.orderstatus.heading2"/><span
						style="font-family: SapientSansMedium; font-size: 15px; color: #de2728;">*</span>
				</p>
				<select name="orderType">
					<option value="PURCHASED">Purchased</option>
					<option value="RENTED" selected="selected">Rented</option>
				</select>&nbsp <input type="submit" value="<spring:message code="label.orderstatus.button2"/>"
					style="font-family: Sapient Centro Slab; font-size: 15px; color: #ffffff; background-color: #21addd">
			</form>
			<div id="showDetails">
				<p style="font-family: SapientSansRegular; font-size: 15px;">
					<spring:message code="label.orderstatus.success2"/><span
						style="font-family: SapientSansMedium; font-size: 15px; text-decoration: underline; color: #de2728;">${orderType}</span>
					<spring:message code="label.orderstatus.success3"/>
				</p>

				<br>
				<h4 style="font-family: SapientSansRegular; font-size: 15px;"><spring:message code="label.orderstatus.details"/></h4>
				<div class="container">
					<table id="tablepaging">
						...
						<c:forEach var="itemList" items="${listOflist}">
							<c:forEach var="item" items="${itemList }">
								<tr>
									<td>${item.getOrderItemId()}</td>
									<td>${item.getIsbn()}</td>
									<td>${item.getBookPrice()}</td>
									<td>${item.getOrderQuantity()}</td>
