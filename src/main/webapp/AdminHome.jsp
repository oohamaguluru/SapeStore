...
<script>
	function displayAdminHome() {
		var test = $("#checkAdmin").val();
		if(typeof test=='undefined') {
			alert("Please log in as an admin");
			$("#null").submit();
		} else {
			alert("Please log in as an admin");
			$("#hiddenField").val(test);
			$("#check").submit();
		}
	}
</script>
...
<div id="wrapper" class="homeAdmin"> 
  ...
  <!-- header ends -->
	...
	<input type="hidden" id="checkadmin" value="${userId }">
	<form action="notLoggedIn" id="null"></form>
	<form action="checkLoggedIn" id="check">
		<input type="hidden" id="hiddenField" name="userId">
	</form>
