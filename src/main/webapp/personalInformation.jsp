...
<title>SapeStore-Personal Information</title>
	...
	<div id="wrapper">
		...
		<form:form name="form"
			...
			<div id="header">
				...
				<ul class="topLinks">
					<li>
						<!--form:checkbox id="checkMe" path="checkMe" value="<spring:message code="label.header.partnerstore"/>" onchange="form.submit();"/-->
						<c:choose>
		...
		<div id="mainContent">
			<h2><spring:message code="label.personal.heading"/></h2>				
			<div style="padding-right: 30px;padding-left: 1px"><hr></div>
		   <form:form method="post" id="mainform" action="editProfile" commandName="editUserVO">

	<table cellpadding="10" cellspacing="10">

					<tr>
						<td><spring:message code="label.personal.fullname"/></td>
						<td><div>${editUserVO.user.name} </div></td>
					</tr>
					<tr>
						<td><spring:message code="label.personal.loginname"/></td>
						<td>${editUserVO.user.userId }</td>
					</tr>
					<tr>
						<td><spring:message code="label.personal.password"/></td>
						<td>------------ </td>
					</tr>
					<tr>
						<td><spring:message code="label.personal.email"/></td>
						<td>${editUserVO.user.emailAddress }</td>
					</tr>
					<tr>
						<td><spring:message code="label.personal.addressline1"/></td>
						<td>${editUserVO.address.addressLine1 }</td>
					</tr>
					<tr>
						<td><spring:message code="label.personal.addressline2"/> </td>
						<td>${editUserVO.address.addressLine2}</td>
					</tr>


					<tr>
						<td><spring:message code="label.personal.city"/></td>
						<td><div>${cityName}</div> </td>
					</tr>

					<tr>
						<td><spring:message code="label.personal.state"/></td>
						<td><div>${stateName}</div></td>
					</tr>
					<tr>
						<td><spring:message code="label.personal.zipcode"/></td>
						<td><div>${editUserVO.address.postalCode }</div></td>
					</tr>
					<tr>
						<td><spring:message code="label.personal.phonenumber"/></td>
						<td><div>${editUserVO.user.phone}</div> </td>
					</tr>
					<tr>
						<td><spring:message code="label.personal.mobilenumber"/></td>
						<td>${editUserVO.user.mobileNumber }</td>
					</tr>

					<tr>
					<td></td>
						<td colspan="3" ><input type="submit" style="background-color: grey;color:white; height: 30px; width: 120px; " value="<spring:message code="label.signup.editprofile"/>"></td>
					</tr>
				</table>
</form:form>
