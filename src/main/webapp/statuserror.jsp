       ...
       <div id="wrapper">
              ...
              <div id="mainContent">
                    <h2 style="font-family: SapientSansMedium; font-size: 22px;"><spring:message code="label.orderstatus.heading"/></h2>
                     ...
                     <div id="showDetails"> 
                     <p style="font-family: SapientSansRegular; font-size: 15px;"><spring:message code="label.orderstatus.error"/><span style="font-family: SapientSansMedium; font-size: 15px; text-decoration: underline ;color: #de2728; ">${orderId}</span>.</p>
                     </div>
