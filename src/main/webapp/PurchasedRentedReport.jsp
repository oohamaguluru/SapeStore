...
<title>Purchase Rented Report</title>
...
<body>
	<table id="tablepaging" class="yui"
		...
		<thead>
			<tr>
				<th><spring:message code="label.purchasedrentedreport.category" /> </th>
				<th><spring:message code="label.purchasedrentedreport.bookname" /></th>
				<th><spring:message code="label.purchasedrentedreport.author" /></th>
				<th><spring:message code="label.purchasedrentedreport.publisher" /></th>
				<th><spring:message code="label.purchasedrentedreport.ordertype" /></th>
				<th><spring:message code="label.purchasedrentedreport.qty" /></th>
				<th><spring:message code="label.purchasedrentedreport.buyprice" /></th>
				<th><spring:message code="label.purchasedrentedreport.rentprice" /></th>
