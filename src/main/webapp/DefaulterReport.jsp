...
if(checkedValues!="")
       ...
       location.href=': Url.Action("Action", "defaultersReport")';
       }
else
...
<body>
       ...
       <table id="tablepage" class="paging"
              ...
              <thead>
                     <tr>
                           <th><spring:message code="label.manageorders.customername"/></th>
                           <th><spring:message code="label.orderConfirmation.orderNo"/></th>
                           <th><spring:message code="label.search.bookcat"/></th>
                           <th><spring:message code="label.orderConfirmation.bookName"/></th>
                           <th><spring:message code="label.transactionhistory.duedate"/></th>
                           <th><spring:message code="label.defaulter.return"/></th>
                           <th><spring:message code="label.defaulter.returns"/></th>
                           <th><spring:message code="label.defaulter.rp"/></th>
                           <th><spring:message code="label.defaulter.lf"/></th>
                           <th><spring:message code="label.defaulter.em"/></th>
                     </tr>
              </thead>
              <div id="message"></div>
              <div id="sendMail">
                     <button id="btn" onclick="getEmail()" style="outline: none"><spring:message code="label.defaulter.sem"/></button>
              </div>
              ...
              <c:forEach items="${adminReportsList}" var="current">
                     ...
                     <tbody>
                           <tr>
                                  ...
                                  <td style="width: 100px;">${current.expectedReturnDate}</td>
                                  <c:choose>
